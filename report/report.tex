...
In the above formulas, measurement units of the GFR and the sCr values are mL/min/1.73m$^2$ [{\bf\red Nelle figure l'unita' di misura del GFR va corretta in mL/min/1.73m$^2$.}] and mg/dL respectively, while patients height is expressed in meters and patients age is expressed in years. % this will hold throughout this report.
...
\begin{table}[ht]
  ...
  \begin{tabular}{|l|c|c|c|c|}
    ...
    Simplified Schwartz        &$0.36$  &$1341.80$ &$27.84$  &{\bf\red$-0.3216$}  \\
